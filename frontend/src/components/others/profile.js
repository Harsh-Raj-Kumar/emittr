    ...
    <>
      ...
      <Container maxW="lg" py={8} mt={10}>
        <Box
          ...
          mt={5}
        >
          <Text fontSize="3xl" fontWeight="bold" fontFamily="'Agbalumo', sans-serif" color="#000738">
            Profile
          </Text>
          <Text mt={2} fontSize="xl" textAlign="start"><b>Name:</b> {user.username}</Text>
          <Text fontSize="xl" textAlign="start"><b>Email:</b> {user.email}</Text>
        ...
        <Box
          ...
          textAlign="center"
        >
          <Text fontSize="2xl" fontWeight="bold" textAlign="center" mb={5} fontFamily="'Agbalumo', sans-serif" 
          color="#000738">
            Proficiency List
          </Text>
